...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      h4("Base Scenario"),
      h6("Income growth rate of 3.0% (forecasted in 2008)"),
      h4("Pro-Poor Scenario"),
      h6("Bottom 50% received ~6.9 dollars to match the mean energy consumption (53.146KW)
         observed in 2014"),
      h4("Pro-Poor & Middle-Class"),
      h6("In addition to the pro-poor scenario, it redistributes half of the cost of the
         mean electricity consumption (~3.95 dollars) to the Middle-Class (51-90%)"),
      width = 2),
    mainPanel(
      plotOutput("mainplot"),
